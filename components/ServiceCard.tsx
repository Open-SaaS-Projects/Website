...
export default function ServiceCard({
  ...
  return (
    <AnimateOnScroll delay={delay}>
      <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#6D2FD5]/20 hover:shadow-lg transition-all duration-300 hover:border-[#6D2FD5]/50 group w-full h-[340px]">
        <div className="p-6 relative overflow-hidden h-full flex flex-col">
          ...
          <p className="text-gray-600 relative z-10 overflow-y-auto">{description}</p>
        </div>
      </div>
    </AnimateOnScroll>
  );
