        ...
        <div className="container max-w-7xl mx-auto px-4 py-8 md:py-16 lg:py-20">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8 lg:mb-12">
            ...
            <p className="max-w-3xl text-muted-foreground lg:text-lg leading-relaxed">
              Enterprise-grade data intelligence solutions that turn your raw data into business value
            </p>
          </div>
                ...
                <div className="flex-shrink-0 w-[280px] sm:w-[300px] snap-center">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group">
                    <div className="p-4 md:p-6 relative overflow-hidden">
                      ...
                      <h3 className="text-xl font-semibold mb-2">Automated Data Pipelines</h3>
                      <p className="text-gray-600 relative z-10 text-sm md:text-base">
                        Seamlessly extract, clean, transform, and load data from multiple sources (e.g., CRM, ERP,
                        spreadsheets) into your central system on a schedule or in real-time.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex-shrink-0 w-[280px] sm:w-[300px] snap-center">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group">
                    <div className="p-4 md:p-6 relative overflow-hidden">
                      ...
                      <h3 className="text-xl font-semibold mb-2">Data Quality Monitoring</h3>
                      <p className="text-gray-600 relative z-10 text-sm md:text-base">
                        Detect anomalies, duplicates, and missing values automatically, with real-time alerts and
                        built-in validation rules to ensure clean, trustworthy data.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex-shrink-0 w-[280px] sm:w-[300px] snap-center">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group">
                    <div className="p-4 md:p-6 relative overflow-hidden">
                      ...
                      <h3 className="text-xl font-semibold mb-2">Dynamic Dashboards & Reports</h3>
                      <p className="text-gray-600 relative z-10 text-sm md:text-base">
                        Generate interactive, role-based dashboards and reports tailored to decision-makers, with
                        drill-down capabilities and customizable KPIs.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex-shrink-0 w-[280px] sm:w-[300px] snap-center">
                  <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group">
                    <div className="p-4 md:p-6 relative overflow-hidden">
                      ...
                      <h3 className="text-xl font-semibold mb-2">Integration-Ready Architecture</h3>
                      <p className="text-gray-600 relative z-10 text-sm md:text-base">
                        Easily integrates with popular databases (PostgreSQL, BigQuery), cloud platforms (AWS, Azure), and BI tools (Power BI, Tableau, Looker).
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid lg:grid-cols-2 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
                <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group hover:-translate-y-1">
                  <div className="p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Automated Data Pipelines</h3>
                    <p className="text-gray-600 relative z-10 leading-relaxed">
                      Seamlessly extract, clean, transform, and load data from multiple sources into your central system on schedule or in real-time.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group hover:-translate-y-1">
                  <div className="p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Data Quality Monitoring</h3>
                    <p className="text-gray-600 relative z-10 leading-relaxed">
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group hover:-translate-y-1">
                  <div className="p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Dynamic Dashboards & Reports</h3>
                    <p className="text-gray-600 relative z-10 leading-relaxed">
                      Generate interactive, role-based dashboards and reports tailored to decision-makers, with drill-down capabilities and customizable KPIs.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden border border-[#7C4DFF]/20 hover:shadow-lg transition-all duration-300 hover:border-[#7C4DFF]/50 h-full group hover:-translate-y-1">
                  <div className="p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Integration-Ready Architecture</h3>
                    <p className="text-gray-600 relative z-10 leading-relaxed">
                      Easily integrates with popular databases, cloud platforms (AWS, Azure), and BI tools (Power BI, Tableau, Looker).
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="container max-w-7xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-4 h-full">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Eliminates Manual Data Work</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-4 h-full">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Ensures Consistent & Reliable Insights</h3>
                    <p className="text-gray-600">
                      By catching data issues early and applying transformation rules consistently, your reports and
                      models become far more reliable.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-4 h-full">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Empowers Faster Decisions</h3>
                    <p className="text-gray-600">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow flex items-start gap-4 h-full">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Scales with Your Business</h3>
                    <p className="text-gray-600">
                      Whether you're a startup or an enterprise, the modular, integration-ready system grows with your
